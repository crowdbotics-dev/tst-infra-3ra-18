"""
Django settings for tst_infra_3ra_18 project.
...
ROOT_URLCONF = 'tst_infra_3ra_18.urls'
...
WSGI_APPLICATION = 'tst_infra_3ra_18.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_infra_3ra_18 API",
    "DESCRIPTION": "API documentation for tst_infra_3ra_18 App",
    "VERSION": "v1",
}
